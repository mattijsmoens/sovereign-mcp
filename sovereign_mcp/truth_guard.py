...
Patent: Sovereign Shield Patent 20 (MCP Security Architecture)
         Truth Adapter Validation System (Patent Pending).
"""
...
class TruthGuard:
    ...
    def check_answer(self, session_id: str, answer_text: str) -> tuple:
        ...
        Logic:
            1. No markers → allow (opinion/chat)
            2. Markers + hedging → allow (appropriate uncertainty)
            3. Markers + tool used → allow (verified)
            4. Markers + cached fact → allow (previously verified)
